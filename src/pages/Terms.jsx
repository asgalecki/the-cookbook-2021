...
const Terms = () => {
  ...
  return (
    <StaticWrapper title={'Terms of use'}>
      <h4 className='my-4'>Website Terms of Use</h4>

      <p>Please read these terms and conditions carefully before using Our Service.</p>

      <p>The The Cookbook website located at https://the-cookbook-2021.web.app is a copyrighted work belonging to The Cookbook. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
      ...
      <h5 className='my-4'>User Content</h5>
      ...
      <h5 className='my-4'>Third-Party Links & Ads; Other Users</h5>
      ...
      <p><strong>Cookies and Web Beacons.</strong> Like any other website, The Cookbook uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>

      <h5 className='my-4'>Disclaimers</h5>
      ...
      <h5 className='my-4'>Limitation on Liability</h5>
      ...
      <h5 className='my-4'>Copyright Policy.</h5>
      ...
      <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: cookbookmanager2021@gmail.com. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
      ...
      <p>If you have any questions about these Terms and Conditions, You can contact us by visiting our <Link to={'/contact'}>contact page</Link>.</p>
